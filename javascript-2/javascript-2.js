...
for (let i = 0; i < saleProducts.length; i++) {
  saleProducts[i].price = saleProducts[i].price * 0.75
}

// for(let key in saleProducts[i]){
...
//CODE HERE
let blueProducts = []
blueProducts = saleProducts.filter(function (e) {
...
//CODE HERE
const bluePrices = []
blueProducts.forEach(function (e) {
  bluePrices.push(e.price)
})
const orderTotal = bluePrices.reduce(function (acc, curr) {
  return acc + curr
})
//////////////////////////////////PROBLEMS 5-8//////////////////////////////////
/*
...
let person = {
  name: 'Toby',
  age: 2,
  jobs: ['pooper scooper', 'dentist', 'operator'],
  birthday: function () {
    this.age++
  },
  favorites: {
